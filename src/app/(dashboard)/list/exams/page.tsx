...
type ExamType = Exam & {lesson: {subject: Subject, teacher: Teacher, class: Class}};
...
const ExamsList = async ({
  ...
  const [data, count] = await prisma.$transaction([
    prisma.exam.findMany({
      where: query,
      include: {
        lesson: { select: { subject: { select: { name: true } }, teacher: {select: {name: true, surname: true}}, class: {select: {name: true}} } },
      },
      take: ITEM_PER_PAGE,
