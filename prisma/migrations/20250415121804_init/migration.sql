...
-- AddForeignKey
ALTER TABLE "Student" ADD CONSTRAINT "Student_classsId_fkey" FOREIGN KEY ("classsId") REFERENCES "Class"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
